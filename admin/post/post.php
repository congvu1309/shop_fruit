    ...
    <div class="table-responsive">
        <div class="container-add-right">
            <div class="container-add">
                <a href="index.php?action=quanlybaiviet&query=them" class="container-add-click">Thêm mới</a>
            </div>
        </div>
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td><p class="td-name"><?php echo substr($row['post_name'], 0, 45) ?>...</p></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="post/xuly.php?idbaiviet=<?php echo $row['post_id'] ?>" class="function_click-delete">Xóa</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
