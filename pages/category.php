...
<body>
    ...
    <?php
    $sql_pro = "SELECT * FROM product WHERE product.category_id = '$_GET[iddanhmuc]' ORDER BY product_id DESC";
    $query_pro = mysqli_query($conn, $sql_pro);

    $sql_cate = "SELECT * FROM category WHERE category.category_id = '$_GET[iddanhmuc]' LIMIT 1";
                        ...
                        <div class="col_product">
                            <div class="product_item">
                                ...
                                <div class="product_text">
                                    ...
                                    <div class="product_price"><?php echo number_format($row['product_price'],0,',','.').'vnđ' ?></div>
                                </div>
                                ...
                                <div class="icon_product">
                                    ...
                                    <a href="detail_product.php?idsanpham=<?php echo $row['product_id'] ?>" class="favorites">Chi tiết</a>
                                    <?php
                                    if ($is_login == true) {
